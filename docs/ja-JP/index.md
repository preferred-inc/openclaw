---
read_when:
  - 新規ユーザーにTSUKASA AIを紹介するとき
summary: TSUKASA AIは、あらゆるOSで動作するAIエージェント向けのマルチチャネルgatewayです。
title: TSUKASA AI
---
...
<p align="center">
  <strong>LINE、Slack、Discord、Telegramなどに対応した、日本の企業向けAIエージェントgateway。</strong><br />
  メッセージを送信すれば、どこからでもエージェントの応答を受け取れます。プラグインでMattermostなどを追加できます。
</p>

<Columns>
  <Card title="はじめに" href="/start/getting-started" icon="rocket">
    TSUKASA AIをインストールし、数分でGatewayを起動できます。
  </Card>
...
TSUKASA AIは、単一のGatewayプロセスを通じてチャットアプリをAIコーディングエージェントに接続します。ローカルまたはリモートのセットアップをサポートし、日本の企業環境に最適化されたAIアシスタントを提供します。
...
<p align="center">
  <img src="/whatsapp-openclaw.jpg" alt="TSUKASA AI" width="420" />
</p>
...
- **何もしなければ**、TSUKASA AIはバンドルされたPiバイナリをRPCモードで使用し、送信者ごとのセッションを作成します。
