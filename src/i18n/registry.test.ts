...
describe("ui i18n locale registry", () => {
  it("lists supported locales", () => {
    expect(SUPPORTED_LOCALES).toEqual(["en", "zh-CN", "zh-TW", "pt-BR", "de", "es", "ja"]);
  ...
  it("resolves browser locale fallbacks", () => {
    ...
    expect(resolveNavigatorLocale("ja-JP")).toBe("ja");
  ...
  it("loads lazy locale translations from the registry", async () => {
    ...
    expect(getNestedTranslation(ja, "common", "health")).toBe(
      "\u30d8\u30eb\u30b9\u30c1\u30a7\u30c3\u30af",
    );
