          ...
          : html`
            <div class="status-list" style="margin-top: 16px;">
              <div>
                ...
                <span>${configured == null ? t("common.na") : configured ? t("channels.status.yes") : t("channels.status.no")}</span>
              </div>
              <div>
                <span class="label">${t("channels.status.running")}</span>
                <span>${running == null ? t("common.na") : running ? t("channels.status.yes") : t("channels.status.no")}</span>
              </div>
              <div>
                <span class="label">${t("channels.status.connected")}</span>
                <span>${connected == null ? t("common.na") : connected ? t("channels.status.yes") : t("channels.status.no")}</span>
              </div>
            </div>
          `
      }
