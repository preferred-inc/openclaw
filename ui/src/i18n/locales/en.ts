...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    audit: "View enterprise audit events and security history.",
  },
  overview: {
    access: {
  ...
  actions: {
    ...
    profileImported: "Profile imported from relays. Review and publish.",
  },
  errors: {
    accessDeniedIp: "Access denied: unable to determine client IP",
    accessDeniedIpPolicy: "Access denied by IP restriction policy",
    hookMappingFailed: "hook mapping failed",
    internalServerError: "Internal Server Error",
    methodNotAllowed: "Method Not Allowed",
    notFound: "Not Found",
    unauthorized: "Unauthorized",
    unknownMethod: "unknown method: {method}",
    unauthorizedRole: "unauthorized role: {role}",
    missingScope: "missing scope: {scope}",
    rateLimitExceeded: "rate limit exceeded for {method}; retry after {seconds}s",
    tooManyAttempts: "Too many failed authentication attempts. Please try again later.",
    hookTokenRequired:
  ...
  usage: {
    ...
    timeZoneUtc: "UTC",
    timeZoneLocal: "Local",
    timeZoneEstimation: "Estimated from session spans (first/last activity). Time zone: {tz}.",
  },
  execApprovals: {
    defaultSecurityMode: "Default security mode.",
    defaultSecurity: "Default: {mode}.",
    defaultPromptPolicy: "Default prompt policy.",
    defaultPrompt: "Default: {policy}.",
  ...
  auditLog: {
    title: "Audit Log",
    subtitle: "Security audit trail of gateway operations.",
